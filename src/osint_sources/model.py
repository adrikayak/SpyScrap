...
class User(BaseModel):
    ...
    def insertUser(user_elem):
        try:
            result = (User
                      .create(name=user_elem['name'], uid=user_elem['uid'], bio=user_elem['bio'],
                              birth=user_elem['birth'], gender=user_elem['gender'], s_number=user_elem['s_number'],
                              location=user_elem['location']))
